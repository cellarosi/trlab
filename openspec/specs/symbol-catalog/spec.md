...
Define the minimal symbol model and JSON loading behavior for financial instrument roots/products such as indices, ETFs, stocks, futures, and option chains.
